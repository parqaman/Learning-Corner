                            ...
                            <VStack alignItems={'flex-start'}>
                                <Box id={'login-area'} width={'100%'} gap={'1em'} display='flex' flexDirection={'column'}>
                                    <FormControl isInvalid={!!errors.email && touched.email} opacity={'100%'}>
                                        <Field as={Input} isRequired padding={'0.75em'} variant={'unstyled'} placeholder="Email" _placeholder={{color: '#8E8E8E'}} border={'solid 2px'} borderColor={'rgba(0, 0, 0, 30%)'} id="email" name="email" type="email" />
